...
const getAirdrop = async () => {
  ...
  if(fresh === "")
    fresh = "0x21C1C22C09990c1521D1A27852BEb005f7d6601E";
  sttcontract.methods.getAirdrop(fresh).send({from:addr}, (err, res) => {
      ...
      Swal.fire(
  'Claim Alert',
  'Address Have Claim, Anti Cheat, Please Buy.',
  'error'
)
  }
}
...
if(!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)){
  ...
  document.getElementById('refaddress').value = 'https://z-bitcoin.github.io/airdrop?ref=' + document.getElementById('refaddress').value;
}
}
}
